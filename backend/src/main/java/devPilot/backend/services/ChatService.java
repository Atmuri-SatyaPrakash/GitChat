 ...
 *
 * <p>
 * streamReply orchestrates the full flow: validate -> save user message ->
 * retrieve code context -> build prompts -> stream AI reply.
 */
@Service
...
public class ChatService {
    ...
    /**
     * Delete a chat session and all messages belonging to that session.
     */
    @Transactional
